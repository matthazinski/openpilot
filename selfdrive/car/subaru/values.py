...
FW_QUERY_CONFIG = FwQueryConfig(
  requests=[
    ...
    Request(
      [StdQueries.EXTENDED_DIAGNOSTIC_REQUEST, StdQueries.TESTER_PRESENT_REQUEST, SUBARU_VERSION_REQUEST],
      [StdQueries.EXTENDED_DIAGNOSTIC_RESPONSE, StdQueries.TESTER_PRESENT_RESPONSE, SUBARU_VERSION_RESPONSE],
    ),
  ],
)
...
GLOBAL_GEN2 = (CAR.OUTBACK, CAR.LEGACY, CAR.OUTBACK_2023, CAR.LEGACY_2023)
